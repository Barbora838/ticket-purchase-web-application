...
public class LoginUtilities {
    ...
    public static ClientInfo verifyTokenResponse(Map<String, Object> map, String sessionId) {
        ...
        String firstName = (String) payloadMap.get(LoginServerConstants.FIRST_NAME_KEY);
        String lastName = (String) payloadMap.get(LoginServerConstants.FAMILY_NAME_KEY);
        String email = (String) payloadMap.get(LoginServerConstants.EMAIL_KEY);
        return new ClientInfo(firstName, lastName, email);
    }
